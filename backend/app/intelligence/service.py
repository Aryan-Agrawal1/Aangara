...
class IndustrialIntelligenceService:
    ...
    def _load_models(self):
        reg_path = os.path.join(self.model_dir, "gei_benchmark_v1.joblib")
        iso_path = os.path.join(self.model_dir, "anomaly_detector_v1.joblib")
        enc_path = os.path.join(self.model_dir, "sector_encoder_v1.joblib")

        self.gei_model = joblib.load(reg_path) if os.path.exists(reg_path) else None
        self.iso_model = joblib.load(iso_path) if os.path.exists(iso_path) else None
        self.encoder = joblib.load(enc_path) if os.path.exists(enc_path) else None
    ...
    def analyze_facility(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        benchmark_res = {
            ...
            "benchmark_model": "CA-GEI-Benchmark-HistGBM-v1.0",
