...
export function CarbonPositionCard({ position, onOpenSourceTrace }: CarbonPositionCardProps) {
  ...
  return (
    <div className="glass-panel rounded-xl p-5 relative overflow-hidden transition-all duration-300 hover:border-[#E4E9E6] border-[#E4E9E6]">
      ...
      <div className="flex items-center justify-between mb-4 relative z-10">
        <div className="flex items-center space-x-2">
          <div className="p-2 rounded-lg bg-[#E8F5EE] border border-emerald-800/60 text-[#1F8A5F] shadow-md backdrop-blur-md">
        ...
        <button
          ...
          className="text-[10px] uppercase font-mono font-bold text-[#2E6BA8] hover:text-[#2E6BA8] flex items-center space-x-1.5 bg-[#EBF3FB]/40 px-3 py-1.5 rounded border border-sky-800/40 transition-colors cursor-pointer"
        >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-1 relative z-10">
        ...
        <div className="bg-[#F6F8F7] rounded-lg p-3 border border-[#E4E9E6]">
          ...
          <div className={`text-lg font-bold tnum mt-0.5 flex items-center space-x-1 ${
            isSurplus ? 'text-[#1F8A5F]' : 'text-[#C33B2E]'
          }`}>
        ...
        <div className={`rounded-lg p-3 border ${
          isSurplus
            ? 'bg-[#E8F5EE] border-emerald-800/40 text-[#1F8A5F]'
            : 'bg-rose-950/30 border-rose-800/40 text-[#C33B2E]'
        }`}>
