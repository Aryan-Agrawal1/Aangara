        ...
        <div>
          <div className="flex items-center justify-between pb-4 border-b border-[#E4E9E6]">
            <div>
              <div className="flex items-center space-x-2">
                <span className="text-xs font-mono font-bold px-2 py-0.5 rounded bg-[#E8F5EE] text-[#0B4A3D] border border-emerald-800/50">
                  STRATEGY TRACE
                </span>
            ...
            <button onClick={onClose} className="p-1.5 rounded-lg bg-[#F6F8F7] hover:bg-white border border-[#E4E9E6] text-[#4B5A54] hover:text-[#10231C]">
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="bg-[#F6F8F7] rounded-xl p-4 border border-[#E4E9E6]">
              <h4 className="text-sm font-bold text-[#10231C] mb-2 flex items-center space-x-2">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs text-[#4B5A54] font-mono bg-white/80 p-3 rounded-lg border border-[#E4E9E6]">
                ...
                <div>Proj Output (Derate):</div><div className="text-[#0B4A3D] font-bold text-right">{assumptions?.project_output_delivery_pct ?? 100}%</div>
